...
public class ChangeProductColorTest extends BaseTest {
     ...
     */
    private final static String anotherColorProductName = "Бейсболка Nike женские мужские Кепка с вышивкой";
    /**
     * Тест смены цвета товара.
     * Шаги теста:
     *   Получаем страницу товара через {@link BaseTest#getProductPage(boolean)}</li>
