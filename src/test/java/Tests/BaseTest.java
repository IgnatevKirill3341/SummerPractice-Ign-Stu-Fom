...
abstract public class BaseTest {
     ...
     *   Если требуется - Выполняет авторизацию
     ...
     */
    protected MainPage start(boolean loginRequired){
     ...
     */
    protected ProductPage getProductPage(boolean loginRequired){
        return search(ARTICLE, loginRequired).openNewPage(ProductPage.class);
    }
    /**
     ...
     */
    protected MainPage search(String request, boolean loginRequired){
        MainPage mainPage = start(loginRequired);
