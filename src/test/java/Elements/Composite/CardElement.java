...
public class CardElement extends BaseElement {
    ...
    private final SpanElement rating = SpanElement.byClass("address-rate-mini address-rate-mini--sm");
    ...
    public static CardElement byClass(String attribute){
        return new CardElement("//article[@class='%s']", attribute);
    }
    /**
    ...
    public static CardElement byClass(String attribute, int index){
        return new CardElement("//article[@class='%s']", attribute, index);
    }
