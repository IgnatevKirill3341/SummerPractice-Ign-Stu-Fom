...
public class ReviewElement extends BaseElement {
    private final static String CLASS_XPATH = "comments__item feedback product-feedbacks__block-wrapper";
    private final static String FEEDBACK_BTN_CLASS = "feedback__menu";
    private final static String OPEN_FORM_CLASS = "menu-btn";
    private final ButtonElement feedBack = ButtonElement.byClass(FEEDBACK_BTN_CLASS);
    private final ButtonElement openForm = ButtonElement.byClass(OPEN_FORM_CLASS);
    /**
    ...
    public static ReviewElement byClass(String attributeValue){
        return new ReviewElement(CLASS_XPATH, attributeValue);
    }
    /**
    ...
    public static ReviewElement byClass(String attributeValue, int index){
        return new ReviewElement(CLASS_XPATH, attributeValue, index);
    }
}
