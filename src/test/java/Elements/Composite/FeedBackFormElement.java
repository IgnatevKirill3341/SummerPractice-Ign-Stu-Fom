...
public class FeedBackFormElement extends BaseElement {
    ...
    private final static String CHOOSE_CLASS = "radio-with-text__decor";
    private final static String SEND_BUTTON = "btn-main";
    private final SpanElement selection = SpanElement.byClass(CHOOSE_CLASS);
    private final ButtonElement sendButton = ButtonElement.byClass(SEND_BUTTON);
    /**
    ...
    public static FeedBackFormElement byClass(String attributeValue, int index){
        return new FeedBackFormElement(CLASS_XPATH, attributeValue, index);
    }
}
